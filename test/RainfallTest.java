...
public class RainfallTest {
    ...
    @Test
    public void noCity() {
        System.out.println("Test no city");
        assertFuzzyEquals(Rainfall.mean("Paperopoli", RainfallTest.data), -1);
        assertFuzzyEquals(Rainfall.variance("Paperopoli", RainfallTest.data), -1);
    }
}